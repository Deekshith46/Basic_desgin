...
# Generated on: Fri Feb 15 18:15:59 IST 2019 (Fri Feb 15 12:45:59 GMT 2019)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Feb15-18:15:41/rtl2intermediate.lec.log -replace
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../rtl/DPA1.v
