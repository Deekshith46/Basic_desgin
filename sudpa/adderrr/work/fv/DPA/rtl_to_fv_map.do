...
# Generated on: Fri Feb 15 16:00:53 IST 2019 (Fri Feb 15 10:30:53 GMT 2019)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/DPA/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/DPA -revised fv_map
...
read_library -liberty -both   /home/vv2trainee2/Desktop/adder/work/../library/fast.lib /home/vv2trainee2/Desktop/adder/work/../library/slow.lib
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../rtl/DPA.v
elaborate_design -golden -root {DPA} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/DPA/fv_map.v.gz
elaborate_design -revised -root {DPA}
