...
# Generated on: Sat Feb 16 12:01:08 IST 2019 (Sat Feb 16 06:31:08 GMT 2019)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Feb16-12:00:49/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/DPA1 -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../rtl/DPA2.v
elaborate_design -golden -root {DPA1} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/DPA1/fv_map.v.gz
